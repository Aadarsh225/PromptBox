...
function handlechatResponse(userMessageRaw) {
  let userMessage = userMessageRaw.trim();
  if (!userMessage && !user.file.data) return;

  user.message = userMessage;

  let html = `<img src="USER1.png" alt="" id="userImage" width="8%">
  ...
  setTimeout(() => {
    let html = `<img src="ChatBot.png" alt="" id="aiImage" width="10%">
             <div class="ai-chat-area">
               <img src="load1.gif" alt="" class="load" width="50px">
             </div>`;
